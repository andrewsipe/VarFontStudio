...
enum InstanceInclusionCommands {
    static let includeAllTitle = "Include All Instances"
    static let excludeAllTitle = "Exclude All Instances"
    static let trimNonOriginalsTitle = "Origin File's Instances Only"
